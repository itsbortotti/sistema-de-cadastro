...
const FILE = path.join(__dirname, 'formasAcesso.json');
const CAMPOS = ['nome', 'descricao', 'tipo', 'observacoes'];

const INICIAIS = [
  { id: '1', nome: 'Web', descricao: '', tipo: '', observacoes: '' },
  { id: '2', nome: 'Desktop', descricao: '', tipo: '', observacoes: '' },
  { id: '3', nome: 'Mobile', descricao: '', tipo: '', observacoes: '' },
  { id: '4', nome: 'API', descricao: '', tipo: '', observacoes: '' },
];

function defaults() {
  return { nome: '', descricao: '', tipo: '', observacoes: '' };
}
